...
:ref:`Memory Foreign API Access <java-tools-memory-management-memory-foreign-api-access-label>`.

:ref:`ZGC <java-tools-memory-management-garbage-collector-gc-zgc-gc-label>`.
