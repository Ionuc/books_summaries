...
- a Publish / Subscribe Framework was introduce to implement Asynchronous, Scalable and Parallel application
- purpose: extablish a standard for asynchronous stream processing ,prioritizin on-blocking backpressure mechanisms
...
- there should be a Publisher and a Subscriber. The Publisher publishes the stream of data and the Subscriber consumes the data
...
- java.util.concurrent.Flow.Subscriber:
    ...
    - There are four methods in this interface
        ...
        - onError: This method is invoked when an irrecoverable error occurs, we can do cleanup tacks in this method, such as closing database connection.
